                        ...
                        {m.content.split("\n\n").map((para, pIdx) => (
                          <p key={pIdx} className={pIdx > 0 ? "mt-2" : ""}>
                            {para.split("**").map((part, partIdx) => {
                              if (partIdx % 2 === 1) {
                                return <strong key={partIdx} className="font-bold text-slate-950 dark:group-hover:text-emerald-300">{part}</strong>;
                              }
                              return part;
                            })}
                          </p>
            ...
            <div className="p-3 bg-white border-t border-slate-100">
              ...
              >
                ...
                <input
                  ...
                  placeholder={isListening ? "Ouvindo... fale agora." : "Digite sua dúvida ou use a voz..."}
              ...
              <div className="flex justify-between items-center mt-2 px-1 text-[9px] text-slate-400 font-mono">
                <span>RAG: Documentos de Metas 2026</span>
